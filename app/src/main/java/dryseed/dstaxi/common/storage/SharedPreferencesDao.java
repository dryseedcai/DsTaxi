package dryseed.dstaxi.common.storage;
...
public class SharedPreferencesDao {
    ...
    public void save(String key, Object object) {
        String value = JSON.toJSONString(object);//new Gson().toJson(object);
        save(key, value);
    }
    ...
    public Object get(String key, Class cls) {
        ...
        try {
            if (value != null) {
                Object o = JSON.parseObject(value, cls);//new Gson().fromJson(value, cls);
                return o;
            }
        } catch (Exception e) {
