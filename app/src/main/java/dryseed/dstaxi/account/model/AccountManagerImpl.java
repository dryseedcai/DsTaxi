package dryseed.dstaxi.account.model;
...
import dryseed.dstaxi.account.model.response.Account;
import dryseed.dstaxi.account.model.response.LoginResponse;
    ...
    public void register(final String phone, final String password) {
        new Thread() {
            ...
            public void run() {
                ...
                request.setBody("uid", DevUtil.UUID(DsApplication.getInstance()));
